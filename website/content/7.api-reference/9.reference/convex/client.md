...
Defined in: [src/convex/client/index.ts:477](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L477)
...
| Property | Type | Description | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="scopes"></a> `scopes?` | `string`[] | Extra OAuth scopes on top of BACKEND\_MCP\_SCOPES (identity scopes plus the built-in tool scopes, always offered). | [src/convex/client/index.ts:482](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L482) |
| <a id="loginpage"></a> `loginPage?` | `string` | The app page agents' users sign in on mid-OAuth. Defaults to the built-in login page path; align with `backend.pages.login` / `backend.loginPath` when those are customized. | [src/convex/client/index.ts:488](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L488) |
| <a id="consentpage"></a> `consentPage?` | `string` | Your own consent page path; the plugin's built-in screen when unset. | [src/convex/client/index.ts:490](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L490) |
| <a id="trustedclients"></a> `trustedClients?` | `Client`[] | Pre-registered clients (e.g. first-party agents with `skipConsent`). | [src/convex/client/index.ts:492](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L492) |
| <a id="oidcconfig"></a> `oidcConfig?` | `OIDCOptions` | Advanced OIDC provider passthrough; the options above win over it. | [src/convex/client/index.ts:494](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L494) |
...
| Property | Type | Description | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="authconfig"></a> `authConfig?` | `AuthConfig` | Override the default auth config (e.g. to add custom providers) | [src/convex/client/index.ts:499](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L499) |
| <a id="authoptions"></a> `authOptions?` | `BetterAuthOptions` | Override Better Auth options (merged with defaults) | [src/convex/client/index.ts:501](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L501) |
| <a id="basepath"></a> `basePath?` | `string` | Override Better Auth basePath and matching Convex auth route | [src/convex/client/index.ts:503](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L503) |
| <a id="admin"></a> `admin?` | `false` \| `AdminOptions` | Admin plugin options (roles via `adminRoles`/`ac`, ban, impersonation). Enabled by default; pass `false` to disable — a disabled plugin still leaves its (optional) schema fields in place. | [src/convex/client/index.ts:509](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L509) |
| <a id="organization"></a> `organization?` | \| `false` \| `OrganizationOptions` & \{ `personal?`: `boolean`; `invitationPath?`: `string`; \} | Organization (workspace) plugin options. Enabled by default with a personal workspace per user (`personal: true`); pass `false` to disable. | [src/convex/client/index.ts:514](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L514) |
| <a id="mcp"></a> `mcp?` | `false` \| [`McpAuthOptions`](#mcpauthoptions) | Agent (MCP) OAuth provider options. Enabled by default — apps built on this package expose an OAuth-protected MCP endpoint out of the box; pass `false` to disable the provider (and the `/mcp/exchange` token mint). | [src/convex/client/index.ts:520](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L520) |

***

### SetupAuthOptions

Defined in: [src/convex/client/index.ts:523](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L523)
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="authconfig-1"></a> `authConfig?` | `AuthConfig` | Override the default auth config (e.g. to add custom providers) | [`CreateBetterAuthOptions`](#createbetterauthoptions).[`authConfig`](#authconfig) | [src/convex/client/index.ts:499](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L499) |
| <a id="authoptions-1"></a> `authOptions?` | `BetterAuthOptions` | Override Better Auth options (merged with defaults) | [`CreateBetterAuthOptions`](#createbetterauthoptions).[`authOptions`](#authoptions) | [src/convex/client/index.ts:501](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L501) |
| <a id="basepath-1"></a> `basePath?` | `string` | Override Better Auth basePath and matching Convex auth route | [`CreateBetterAuthOptions`](#createbetterauthoptions).[`basePath`](#basepath) | [src/convex/client/index.ts:503](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L503) |
| <a id="admin-1"></a> `admin?` | `false` \| `AdminOptions` | Admin plugin options (roles via `adminRoles`/`ac`, ban, impersonation). Enabled by default; pass `false` to disable — a disabled plugin still leaves its (optional) schema fields in place. | [`CreateBetterAuthOptions`](#createbetterauthoptions).[`admin`](#admin) | [src/convex/client/index.ts:509](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L509) |
| <a id="organization-1"></a> `organization?` | \| `false` \| `OrganizationOptions` & \{ `personal?`: `boolean`; `invitationPath?`: `string`; \} | Organization (workspace) plugin options. Enabled by default with a personal workspace per user (`personal: true`); pass `false` to disable. | [`CreateBetterAuthOptions`](#createbetterauthoptions).[`organization`](#organization) | [src/convex/client/index.ts:514](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L514) |
| <a id="mcp-1"></a> `mcp?` | `false` \| [`McpAuthOptions`](#mcpauthoptions) | Agent (MCP) OAuth provider options. Enabled by default — apps built on this package expose an OAuth-protected MCP endpoint out of the box; pass `false` to disable the provider (and the `/mcp/exchange` token mint). | [`CreateBetterAuthOptions`](#createbetterauthoptions).[`mcp`](#mcp) | [src/convex/client/index.ts:520](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L520) |
| <a id="schema-1"></a> `schema?` | `Schema` | Local Better Auth schema for hybrid/local component installs | - | [src/convex/client/index.ts:528](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L528) |
| <a id="verbose"></a> `verbose?` | `boolean` | Enable verbose logs in the Better Auth Convex component client | - | [src/convex/client/index.ts:530](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L530) |
| <a id="integrations"></a> `integrations?` | [`AuthIntegrations`](#authintegrations)\<`DM`\> | Cross-component wiring: an email transport for auth emails, a rate limiter for OTP sends, a `canSignIn` gate, and the `onUserCreated` / `onUserDeleted` lifecycle hooks. See [AuthIntegrations](#authintegrations). | - | [src/convex/client/index.ts:536](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L536) |

***

### AuthSetupComponents

Defined in: [src/convex/client/index.ts:553](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L553)
...
| Property | Type | Defined in |
| ------ | ------ | ------ |
| <a id="backend"></a> `backend` | `PublicAuthComponentRef` | [src/convex/client/index.ts:554](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L554) |
...
Defined in: [src/convex/client/index.ts:447](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L447)
...
Defined in: [src/convex/client/index.ts:462](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L462)
...
| ------ | ------ | ------ |
| `personal?` | `boolean` | [src/convex/client/index.ts:463](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L463) |
| `invitationPath?` | `string` | [src/convex/client/index.ts:464](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L464) |
...
Defined in: [src/convex/client/index.ts:766](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L766)
...
| `basePath` | `string` | `resolvedBasePath` | - | [src/convex/client/index.ts:982](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L982) |
| `database` | `AdapterFactory`\<`BetterAuthOptions`\> | - | - | [src/convex/client/index.ts:983](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L983) |
| `emailAndPassword` | \{ `disableSignUp?`: `boolean`; `requireEmailVerification?`: `boolean`; `maxPasswordLength?`: `number`; `minPasswordLength?`: `number`; `sendResetPassword?`: (`data`, `request?`) => `Promise`\<`void`\>; `resetPasswordTokenExpiresIn?`: `number`; `onPasswordReset?`: (`data`, `request?`) => `Promise`\<`void`\>; `password?`: \{ `hash?`: (`password`) => `Promise`\<`string`\>; `verify?`: (`data`) => `Promise`\<`boolean`\>; \}; `autoSignIn?`: `boolean`; `revokeSessionsOnPasswordReset?`: `boolean`; `onExistingUserSignUp?`: (`data`, `request?`) => `Promise`\<`void`\>; `customSyntheticUser?`: (`params`) => `Record`\<`string`, `unknown`\>; `enabled`: `boolean`; \} | - | - | [src/convex/client/index.ts:985](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L985) |
...
| `emailAndPassword.enabled` | `boolean` | `false` | Enable email and password authentication **Default** `false` | [src/convex/client/index.ts:986](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L986) |
| `user` | \{ `modelName?`: `"user"` \| `LiteralString`; `fields?`: `Partial`\<`Record`\<`"createdAt"` \| `"updatedAt"` \| `"email"` \| `"emailVerified"` \| `"name"` \| `"image"`, `string`\>\>; `additionalFields?`: \{ \[`key`: `string`\]: `DBFieldAttribute`; \}; `changeEmail?`: \{ `enabled`: `boolean`; `sendChangeEmailConfirmation?`: (`data`, `request?`) => `Promise`\<`void`\>; `updateEmailWithoutVerification?`: `boolean`; \}; `deleteUser?`: \{ `enabled?`: `boolean`; `sendDeleteAccountVerification?`: (`data`, `request?`) => `Promise`\<`void`\>; `beforeDelete?`: (`user`, `request?`) => `Promise`\<`void`\>; `afterDelete?`: (`user`, `request?`) => `Promise`\<`void`\>; `deleteTokenExpiresIn?`: `number`; \}; \} | - | - | [src/convex/client/index.ts:991](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L991) |
...
Defined in: [src/convex/client/index.ts:1088](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1088)
...
Defined in: [src/convex/client/index.ts:1095](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1095)
...
Defined in: [src/convex/client/index.ts:1122](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1122)
...
Defined in: [src/convex/client/index.ts:1168](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1168)
...
| Name | Type | Defined in |
| ------ | ------ | ------ |
| `getAuthUser` | `RegisteredQuery`\<`"public"`, \{ \}, `Promise`\<`MaybeMakeLooseDataModel`\<\{ \[TableName in string\]: Schema\["tables"\]\[TableName\] extends TableDefinition\<DocumentType, Indexes, SearchIndexes, VectorIndexes\> ? \{ document: Expand\<(...) & (...)\>; fieldPaths: "\_id" \| ExtractFieldPaths\<(...)\>; indexes: Expand\<(...) & (...)\>; searchIndexes: SearchIndexes; vectorIndexes: VectorIndexes \} : never \}, `Schema`\[`"strictTableNameTypes"`\]\>\[`"user"`\]\[`"document"`\]\>\> | [src/convex/client/index.ts:1301](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1301) |
| `authConfig` | `RegisteredQuery`\<`"public"`, \{ \}, `Promise`\<\{ `invitationPath`: `string` \| `null`; \}\>\> | [src/convex/client/index.ts:1302](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1302) |
| `listWorkspaces` | `RegisteredQuery`\<`"public"`, \{ \}, `Promise`\< \| \{ `id`: `string`; `name`: `string`; `slug`: `string`; `logo`: `string` \| `null`; `role`: `string`; `active`: `boolean`; `joinedAt`: `number`; \}[] \| `null`\>\> | [src/convex/client/index.ts:1303](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1303) |
| `listWorkspaceMembers` | `RegisteredQuery`\<`"public"`, \{ `organizationId?`: `string`; \}, `Promise`\< \| \{ `organizationId`: `string`; `members`: \{ `userId`: `string`; `name`: `string`; `email`: `string`; `role`: `string`; `joinedAt`: `number`; \}[]; \} \| `null`\>\> | [src/convex/client/index.ts:1304](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1304) |
| `updateProfile` | `RegisteredMutation`\<`"public"`, \{ `name`: `string`; \}, `Promise`\<`null`\>\> | [src/convex/client/index.ts:1305](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1305) |
...
Defined in: [src/convex/client/index.ts:1326](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1326)
...
| `options.basePath` | `string` | `resolvedBasePath` | - | [src/convex/client/index.ts:982](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L982) |
| `options.database` | `AdapterFactory`\<`BetterAuthOptions`\> | - | - | [src/convex/client/index.ts:983](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L983) |
...
| `options.emailAndPassword.enabled` | `boolean` | `false` | Enable email and password authentication **Default** `false` | [src/convex/client/index.ts:986](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L986) |
