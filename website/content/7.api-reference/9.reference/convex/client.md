...
Defined in: [nuxt-backend/src/convex/client/index.ts:41](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L41)
...
| ------ | ------ | ------ |
| <a id="runmutation"></a> `runMutation` | \<`Mutation`\>(`mutation`, ...`args`) => `Promise`\<`FunctionReturnType`\<`Mutation`\>\> | [nuxt-backend/src/convex/client/index.ts:42](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L42) |
| <a id="runquery"></a> `runQuery` | \<`Query`\>(`query`, ...`args`) => `Promise`\<`FunctionReturnType`\<`Query`\>\> | [nuxt-backend/src/convex/client/index.ts:43](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L43) |
| <a id="scheduler"></a> `scheduler` | `Scheduler` | [nuxt-backend/src/convex/client/index.ts:44](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L44) |

***

### AuthEmailMessage

Defined in: [nuxt-backend/src/convex/client/index.ts:48](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L48)
...
| Property | Type | Defined in |
| ------ | ------ | ------ |
| <a id="to"></a> `to` | `string` | [nuxt-backend/src/convex/client/index.ts:49](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L49) |
| <a id="subject"></a> `subject` | `string` | [nuxt-backend/src/convex/client/index.ts:50](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L50) |
| <a id="html"></a> `html?` | `string` | [nuxt-backend/src/convex/client/index.ts:51](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L51) |
| <a id="text"></a> `text?` | `string` | [nuxt-backend/src/convex/client/index.ts:52](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L52) |

***

### AuthRateLimiter

Defined in: [nuxt-backend/src/convex/client/index.ts:74](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L74)
...
| Property | Type | Defined in |
| ------ | ------ | ------ |
| <a id="limit"></a> `limit` | (`ctx`, `name`, `options?`) => `Promise`\<\{ `ok`: `boolean`; `retryAfter?`: `number`; \}\> | [nuxt-backend/src/convex/client/index.ts:75](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L75) |

***

### AuthCreatedUser

Defined in: [nuxt-backend/src/convex/client/index.ts:83](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L83)
...
| Property | Type | Defined in |
| ------ | ------ | ------ |
| <a id="id"></a> `id` | `string` | [nuxt-backend/src/convex/client/index.ts:84](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L84) |
| <a id="email"></a> `email` | `string` | [nuxt-backend/src/convex/client/index.ts:85](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L85) |
| <a id="name"></a> `name` | `string` | [nuxt-backend/src/convex/client/index.ts:86](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L86) |

***

### AuthIntegrations

Defined in: [nuxt-backend/src/convex/client/index.ts:105](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L105)
...
| ------ | ------ | ------ | ------ |
| <a id="email-1"></a> `email?` | [`AuthEmailSender`](#authemailsender) | - | [nuxt-backend/src/convex/client/index.ts:106](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L106) |
| <a id="ratelimiter"></a> `rateLimiter?` | [`AuthRateLimiter`](#authratelimiter) | - | [nuxt-backend/src/convex/client/index.ts:107](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L107) |
| <a id="onusercreated-1"></a> `onUserCreated?` | [`OnUserCreated`](#onusercreated)\<`DM`\> | - | [nuxt-backend/src/convex/client/index.ts:108](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L108) |
| <a id="emailtemplates"></a> `emailTemplates?` | `Partial`\<[`AuthEmailTemplates`](#authemailtemplates)\> | Override any of the default auth-email templates (welcome/otp/verify/change/delete/invite). | [nuxt-backend/src/convex/client/index.ts:110](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L110) |
| <a id="welcomeemail"></a> `welcomeEmail?` | `boolean` | Send the packaged welcome email right after signup (default `true`). Set `false` when the app owns onboarding — e.g. a durable email sequence started from `onUserCreated` — so new users don't get two welcomes. | [nuxt-backend/src/convex/client/index.ts:116](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L116) |

***

### AuthEmailTemplates

Defined in: [nuxt-backend/src/convex/client/index.ts:186](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L186)
...
| Property | Type | Description | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="otp"></a> `otp` | (`data`) => [`AuthEmailMessage`](#authemailmessage) | OTP code email (sign-in / email-verification / change-email). | [nuxt-backend/src/convex/client/index.ts:188](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L188) |
| <a id="welcome"></a> `welcome` | (`data`) => [`AuthEmailMessage`](#authemailmessage) | Welcome email sent once, right after a user is created. | [nuxt-backend/src/convex/client/index.ts:190](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L190) |
| <a id="verify"></a> `verify` | (`data`) => [`AuthEmailMessage`](#authemailmessage) | Email-verification link (when verification is enabled). | [nuxt-backend/src/convex/client/index.ts:192](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L192) |
| <a id="changeemail"></a> `changeEmail` | (`data`) => [`AuthEmailMessage`](#authemailmessage) | Confirmation sent to the current address when changing email. | [nuxt-backend/src/convex/client/index.ts:194](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L194) |
| <a id="deleteaccount"></a> `deleteAccount` | (`data`) => [`AuthEmailMessage`](#authemailmessage) | Confirmation link for account deletion. | [nuxt-backend/src/convex/client/index.ts:196](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L196) |
| <a id="invite"></a> `invite` | (`data`) => [`AuthEmailMessage`](#authemailmessage) | Workspace invitation with an accept link (organization plugin). | [nuxt-backend/src/convex/client/index.ts:198](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L198) |

***

### McpAuthOptions

Defined in: [nuxt-backend/src/convex/client/index.ts:320](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L320)
...
| Property | Type | Description | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="scopes"></a> `scopes?` | `string`[] | Extra OAuth scopes on top of BACKEND\_MCP\_SCOPES (identity scopes plus the built-in tool scopes, always offered). | [nuxt-backend/src/convex/client/index.ts:325](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L325) |
| <a id="loginpage"></a> `loginPage?` | `string` | The app page agents' users sign in on mid-OAuth. Defaults to the built-in login page path; align with `backend.pages.login` / `backend.loginPath` when those are customized. | [nuxt-backend/src/convex/client/index.ts:331](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L331) |
| <a id="consentpage"></a> `consentPage?` | `string` | Your own consent page path; the plugin's built-in screen when unset. | [nuxt-backend/src/convex/client/index.ts:333](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L333) |
| <a id="trustedclients"></a> `trustedClients?` | `Client`[] | Pre-registered clients (e.g. first-party agents with `skipConsent`). | [nuxt-backend/src/convex/client/index.ts:335](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L335) |
| <a id="oidcconfig"></a> `oidcConfig?` | `OIDCOptions` | Advanced OIDC provider passthrough; the options above win over it. | [nuxt-backend/src/convex/client/index.ts:337](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L337) |

***

### CreateBetterAuthOptions

Defined in: [nuxt-backend/src/convex/client/index.ts:340](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L340)
...
| Property | Type | Description | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="authconfig"></a> `authConfig?` | `AuthConfig` | Override the default auth config (e.g. to add custom providers) | [nuxt-backend/src/convex/client/index.ts:342](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L342) |
| <a id="authoptions"></a> `authOptions?` | `BetterAuthOptions` | Override Better Auth options (merged with defaults) | [nuxt-backend/src/convex/client/index.ts:344](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L344) |
| <a id="basepath"></a> `basePath?` | `string` | Override Better Auth basePath and matching Convex auth route | [nuxt-backend/src/convex/client/index.ts:346](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L346) |
| <a id="admin"></a> `admin?` | `false` \| `AdminOptions` | Admin plugin options (roles via `adminRoles`/`ac`, ban, impersonation). Enabled by default; pass `false` to disable — a disabled plugin still leaves its (optional) schema fields in place. | [nuxt-backend/src/convex/client/index.ts:352](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L352) |
| <a id="organization"></a> `organization?` | \| `false` \| `OrganizationOptions` & \{ `personal?`: `boolean`; `invitationPath?`: `string`; \} | Organization (workspace) plugin options. Enabled by default with a personal workspace per user (`personal: true`); pass `false` to disable. | [nuxt-backend/src/convex/client/index.ts:357](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L357) |
| <a id="mcp"></a> `mcp?` | `false` \| [`McpAuthOptions`](#mcpauthoptions) | Agent (MCP) OAuth provider options. Enabled by default — apps built on this package expose an OAuth-protected MCP endpoint out of the box; pass `false` to disable the provider (and the `/mcp/exchange` token mint). | [nuxt-backend/src/convex/client/index.ts:363](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L363) |

***

### SetupAuthOptions

Defined in: [nuxt-backend/src/convex/client/index.ts:366](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L366)
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="authconfig-1"></a> `authConfig?` | `AuthConfig` | Override the default auth config (e.g. to add custom providers) | [`CreateBetterAuthOptions`](#createbetterauthoptions).[`authConfig`](#authconfig) | [nuxt-backend/src/convex/client/index.ts:342](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L342) |
| <a id="authoptions-1"></a> `authOptions?` | `BetterAuthOptions` | Override Better Auth options (merged with defaults) | [`CreateBetterAuthOptions`](#createbetterauthoptions).[`authOptions`](#authoptions) | [nuxt-backend/src/convex/client/index.ts:344](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L344) |
| <a id="basepath-1"></a> `basePath?` | `string` | Override Better Auth basePath and matching Convex auth route | [`CreateBetterAuthOptions`](#createbetterauthoptions).[`basePath`](#basepath) | [nuxt-backend/src/convex/client/index.ts:346](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L346) |
| <a id="admin-1"></a> `admin?` | `false` \| `AdminOptions` | Admin plugin options (roles via `adminRoles`/`ac`, ban, impersonation). Enabled by default; pass `false` to disable — a disabled plugin still leaves its (optional) schema fields in place. | [`CreateBetterAuthOptions`](#createbetterauthoptions).[`admin`](#admin) | [nuxt-backend/src/convex/client/index.ts:352](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L352) |
| <a id="organization-1"></a> `organization?` | \| `false` \| `OrganizationOptions` & \{ `personal?`: `boolean`; `invitationPath?`: `string`; \} | Organization (workspace) plugin options. Enabled by default with a personal workspace per user (`personal: true`); pass `false` to disable. | [`CreateBetterAuthOptions`](#createbetterauthoptions).[`organization`](#organization) | [nuxt-backend/src/convex/client/index.ts:357](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L357) |
| <a id="mcp-1"></a> `mcp?` | `false` \| [`McpAuthOptions`](#mcpauthoptions) | Agent (MCP) OAuth provider options. Enabled by default — apps built on this package expose an OAuth-protected MCP endpoint out of the box; pass `false` to disable the provider (and the `/mcp/exchange` token mint). | [`CreateBetterAuthOptions`](#createbetterauthoptions).[`mcp`](#mcp) | [nuxt-backend/src/convex/client/index.ts:363](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L363) |
| <a id="schema-1"></a> `schema?` | `Schema` | Local Better Auth schema for hybrid/local component installs | - | [nuxt-backend/src/convex/client/index.ts:371](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L371) |
| <a id="verbose"></a> `verbose?` | `boolean` | Enable verbose logs in the Better Auth Convex component client | - | [nuxt-backend/src/convex/client/index.ts:373](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L373) |
| <a id="integrations"></a> `integrations?` | [`AuthIntegrations`](#authintegrations)\<`DM`\> | Cross-component wiring: an email transport for auth emails, a rate limiter for OTP sends, and an `onUserCreated` hook. See [AuthIntegrations](#authintegrations). | - | [nuxt-backend/src/convex/client/index.ts:378](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L378) |

***

### AuthSetupComponents

Defined in: [nuxt-backend/src/convex/client/index.ts:395](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L395)
...
| Property | Type | Defined in |
| ------ | ------ | ------ |
| <a id="backend"></a> `backend` | `PublicAuthComponentRef` | [nuxt-backend/src/convex/client/index.ts:396](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L396) |
...
Defined in: [nuxt-backend/src/convex/client/index.ts:61](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L61)
...
```ts
type AuthRateLimitName = "emailOtp" | "mcp";
```

Defined in: [nuxt-backend/src/convex/client/index.ts:68](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L68)
...
Defined in: [nuxt-backend/src/convex/client/index.ts:94](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L94)
...
Defined in: [nuxt-backend/src/convex/client/index.ts:290](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L290)
...
Defined in: [nuxt-backend/src/convex/client/index.ts:305](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L305)
...
| ------ | ------ | ------ |
| `personal?` | `boolean` | [nuxt-backend/src/convex/client/index.ts:306](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L306) |
| `invitationPath?` | `string` | [nuxt-backend/src/convex/client/index.ts:307](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L307) |
...
Defined in: [nuxt-backend/src/convex/client/index.ts:215](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L215)
...
Defined in: [nuxt-backend/src/convex/client/index.ts:573](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L573)
...
| `basePath` | `string` | `resolvedBasePath` | - | [nuxt-backend/src/convex/client/index.ts:716](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L716) |
| `database` | `AdapterFactory`\<`BetterAuthOptions`\> | - | - | [nuxt-backend/src/convex/client/index.ts:717](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L717) |
| `emailAndPassword` | \{ `disableSignUp?`: `boolean`; `requireEmailVerification?`: `boolean`; `maxPasswordLength?`: `number`; `minPasswordLength?`: `number`; `sendResetPassword?`: (`data`, `request?`) => `Promise`\<`void`\>; `resetPasswordTokenExpiresIn?`: `number`; `onPasswordReset?`: (`data`, `request?`) => `Promise`\<`void`\>; `password?`: \{ `hash?`: (`password`) => `Promise`\<`string`\>; `verify?`: (`data`) => `Promise`\<`boolean`\>; \}; `autoSignIn?`: `boolean`; `revokeSessionsOnPasswordReset?`: `boolean`; `onExistingUserSignUp?`: (`data`, `request?`) => `Promise`\<`void`\>; `customSyntheticUser?`: (`params`) => `Record`\<`string`, `unknown`\>; `enabled`: `boolean`; \} | - | - | [nuxt-backend/src/convex/client/index.ts:719](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L719) |
...
| `emailAndPassword.enabled` | `boolean` | `false` | Enable email and password authentication **Default** `false` | [nuxt-backend/src/convex/client/index.ts:720](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L720) |
| `user` | \{ `modelName?`: `"user"` \| `LiteralString`; `fields?`: `Partial`\<`Record`\<`"createdAt"` \| `"updatedAt"` \| `"email"` \| `"emailVerified"` \| `"name"` \| `"image"`, `string`\>\>; `additionalFields?`: \{ \[`key`: `string`\]: `DBFieldAttribute`; \}; `changeEmail?`: \{ `enabled`: `boolean`; `sendChangeEmailConfirmation?`: (`data`, `request?`) => `Promise`\<`void`\>; `updateEmailWithoutVerification?`: `boolean`; \}; `deleteUser?`: \{ `enabled?`: `boolean`; `sendDeleteAccountVerification?`: (`data`, `request?`) => `Promise`\<`void`\>; `beforeDelete?`: (`user`, `request?`) => `Promise`\<`void`\>; `afterDelete?`: (`user`, `request?`) => `Promise`\<`void`\>; `deleteTokenExpiresIn?`: `number`; \}; \} | - | - | [nuxt-backend/src/convex/client/index.ts:725](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L725) |
...
Defined in: [nuxt-backend/src/convex/client/index.ts:835](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L835)
...
Defined in: [nuxt-backend/src/convex/client/index.ts:842](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L842)
...
Defined in: [nuxt-backend/src/convex/client/index.ts:869](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L869)
...
Defined in: [nuxt-backend/src/convex/client/index.ts:915](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L915)
...
| Name | Type | Defined in |
| ------ | ------ | ------ |
| `getAuthUser` | `RegisteredQuery`\<`"public"`, \{ \}, `Promise`\<`MaybeMakeLooseDataModel`\<\{ \[TableName in string\]: Schema\["tables"\]\[TableName\] extends TableDefinition\<DocumentType, Indexes, SearchIndexes, VectorIndexes\> ? \{ document: Expand\<(...) & (...)\>; fieldPaths: "\_id" \| ExtractFieldPaths\<(...)\>; indexes: Expand\<(...) & (...)\>; searchIndexes: SearchIndexes; vectorIndexes: VectorIndexes \} : never \}, `Schema`\[`"strictTableNameTypes"`\]\>\[`"user"`\]\[`"document"`\]\>\> | [nuxt-backend/src/convex/client/index.ts:1048](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1048) |
| `authConfig` | `RegisteredQuery`\<`"public"`, \{ \}, `Promise`\<\{ `invitationPath`: `string` \| `null`; \}\>\> | [nuxt-backend/src/convex/client/index.ts:1049](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1049) |
| `listWorkspaces` | `RegisteredQuery`\<`"public"`, \{ \}, `Promise`\< \| \{ `id`: `string`; `name`: `string`; `slug`: `string`; `logo`: `string` \| `null`; `role`: `string`; `active`: `boolean`; `joinedAt`: `number`; \}[] \| `null`\>\> | [nuxt-backend/src/convex/client/index.ts:1050](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1050) |
| `listWorkspaceMembers` | `RegisteredQuery`\<`"public"`, \{ `organizationId?`: `string`; \}, `Promise`\< \| \{ `organizationId`: `string`; `members`: \{ `userId`: `string`; `name`: `string`; `email`: `string`; `role`: `string`; `joinedAt`: `number`; \}[]; \} \| `null`\>\> | [nuxt-backend/src/convex/client/index.ts:1051](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1051) |
| `updateProfile` | `RegisteredMutation`\<`"public"`, \{ `name`: `string`; \}, `Promise`\<`null`\>\> | [nuxt-backend/src/convex/client/index.ts:1052](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1052) |
...
Defined in: [nuxt-backend/src/convex/client/index.ts:1073](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1073)
...
| `options.basePath` | `string` | `resolvedBasePath` | - | [nuxt-backend/src/convex/client/index.ts:716](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L716) |
| `options.database` | `AdapterFactory`\<`BetterAuthOptions`\> | - | - | [nuxt-backend/src/convex/client/index.ts:717](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L717) |
...
| `options.emailAndPassword.enabled` | `boolean` | `false` | Enable email and password authentication **Default** `false` | [nuxt-backend/src/convex/client/index.ts:720](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L720) |
