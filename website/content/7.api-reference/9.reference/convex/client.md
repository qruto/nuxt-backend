...
| `hooks` | \| \{ `before?`: (`inputContext`) => `Promise`\<`unknown`\>; `after?`: (`inputContext`) => `Promise`\<`unknown`\>; \} \| `undefined` | - | - | [src/convex/client/index.ts:985](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L985) |
...
| `options.hooks` | \| \{ `before?`: (`inputContext`) => `Promise`\<`unknown`\>; `after?`: (`inputContext`) => `Promise`\<`unknown`\>; \} \| `undefined` | - | - | [src/convex/client/index.ts:985](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L985) |
