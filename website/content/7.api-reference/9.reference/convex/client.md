...
Defined in: [src/convex/client/index.ts:80](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L80)
...
Defined in: [src/convex/client/index.ts:85](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L85)
...
Defined in: [src/convex/client/index.ts:93](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L93)
...
| Property | Type | Defined in |
| ------ | ------ | ------ |
| <a id="id"></a> `id` | `string` | [src/convex/client/index.ts:94](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L94) |
| <a id="email"></a> `email` | `string` | [src/convex/client/index.ts:95](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L95) |
| <a id="name"></a> `name` | `string` | [src/convex/client/index.ts:96](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L96) |

***

### AuthDeletedUser

Defined in: [src/convex/client/index.ts:108](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L108)
...
| Property | Type | Defined in |
| ------ | ------ | ------ |
| <a id="id-1"></a> `id` | `string` | [src/convex/client/index.ts:109](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L109) |
| <a id="email-1"></a> `email` | `string` | [src/convex/client/index.ts:110](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L110) |
| <a id="name-1"></a> `name` | `string` | [src/convex/client/index.ts:111](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L111) |

***

### CanSignInInput

Defined in: [src/convex/client/index.ts:136](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L136)
...
| ------ | ------ | ------ | ------ |
| <a id="email-2"></a> `email` | `string` | The address, as Better Auth holds it (lower-cased). | [src/convex/client/index.ts:138](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L138) |
| <a id="isnewuser"></a> `isNewUser` | `boolean` | `true` when no account exists for the address yet. | [src/convex/client/index.ts:140](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L140) |
| <a id="purpose"></a> `purpose` | [`CanSignInPurpose`](#cansigninpurpose) | - | [src/convex/client/index.ts:141](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L141) |

***

### AuthIntegrations

Defined in: [src/convex/client/index.ts:170](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L170)
...
| Property | Type | Description | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="email-3"></a> `email?` | [`AuthEmailSender`](#authemailsender) | - | [src/convex/client/index.ts:171](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L171) |
| <a id="ratelimiter"></a> `rateLimiter?` | [`AuthRateLimiter`](#authratelimiter) | - | [src/convex/client/index.ts:172](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L172) |
| <a id="onusercreated-1"></a> `onUserCreated?` | [`OnUserCreated`](#onusercreated)\<`DM`\> | - | [src/convex/client/index.ts:173](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L173) |
| <a id="cansignin-1"></a> `canSignIn?` | [`CanSignIn`](#cansignin)\<`DM`\> | Gate sign-in / sign-up (invite-only, allow-list, closed beta). See [CanSignIn](#cansignin). | [src/convex/client/index.ts:175](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L175) |
| <a id="onuserdeleted-1"></a> `onUserDeleted?` | [`OnUserDeleted`](#onuserdeleted)\<`DM`\> | Fired after an account is deleted, after any consumer `afterDelete`. See [OnUserDeleted](#onuserdeleted). | [src/convex/client/index.ts:177](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L177) |
| <a id="emailtemplates"></a> `emailTemplates?` | `Partial`\<[`AuthEmailTemplates`](#authemailtemplates)\> | Override any of the default auth-email templates (welcome/otp/verify/change/delete/invite). | [src/convex/client/index.ts:179](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L179) |
| <a id="welcomeemail"></a> `welcomeEmail?` | `boolean` | Send the packaged welcome email right after signup (default `true`). Set `false` when the app owns onboarding — e.g. a durable email sequence started from `onUserCreated` — so new users don't get two welcomes. | [src/convex/client/index.ts:185](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L185) |

***

### AuthEmailTemplates

Defined in: [src/convex/client/index.ts:261](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L261)
...
| Property | Type | Description | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="otp"></a> `otp` | (`data`) => [`AuthEmailMessage`](#authemailmessage) | OTP code email (sign-in / email-verification / change-email). | [src/convex/client/index.ts:263](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L263) |
| <a id="welcome"></a> `welcome` | (`data`) => [`AuthEmailMessage`](#authemailmessage) | Welcome email sent once, right after a user is created. | [src/convex/client/index.ts:265](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L265) |
| <a id="verify"></a> `verify` | (`data`) => [`AuthEmailMessage`](#authemailmessage) | Email-verification link (when verification is enabled). | [src/convex/client/index.ts:267](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L267) |
| <a id="changeemail"></a> `changeEmail` | (`data`) => [`AuthEmailMessage`](#authemailmessage) | Confirmation sent to the current address when changing email. | [src/convex/client/index.ts:269](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L269) |
| <a id="deleteaccount"></a> `deleteAccount` | (`data`) => [`AuthEmailMessage`](#authemailmessage) | Confirmation link for account deletion. | [src/convex/client/index.ts:271](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L271) |
| <a id="invite"></a> `invite` | (`data`) => [`AuthEmailMessage`](#authemailmessage) | Workspace invitation with an accept link (organization plugin). | [src/convex/client/index.ts:273](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L273) |

***

### McpAuthOptions

Defined in: [src/convex/client/index.ts:570](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L570)
...
| Property | Type | Description | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="scopes"></a> `scopes?` | `string`[] | Extra OAuth scopes on top of BACKEND\_MCP\_SCOPES (identity scopes plus the built-in tool scopes, always offered). | [src/convex/client/index.ts:575](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L575) |
| <a id="loginpage"></a> `loginPage?` | `string` | The app page agents' users sign in on mid-OAuth. Defaults to the built-in login page path; align with `backend.pages.login` / `backend.loginPath` when those are customized. | [src/convex/client/index.ts:581](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L581) |
| <a id="consentpage"></a> `consentPage?` | `string` | Your own consent page path; the plugin's built-in screen when unset. | [src/convex/client/index.ts:583](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L583) |
| <a id="trustedclients"></a> `trustedClients?` | `Client`[] | Pre-registered clients (e.g. first-party agents with `skipConsent`). | [src/convex/client/index.ts:585](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L585) |
| <a id="oidcconfig"></a> `oidcConfig?` | `OIDCOptions` | Advanced OIDC provider passthrough; the options above win over it. | [src/convex/client/index.ts:587](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L587) |

***

### CreateBetterAuthOptions

Defined in: [src/convex/client/index.ts:590](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L590)
...
| Property | Type | Description | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="authconfig"></a> `authConfig?` | `AuthConfig` | Override the default auth config (e.g. to add custom providers) | [src/convex/client/index.ts:592](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L592) |
| <a id="authoptions"></a> `authOptions?` | `BetterAuthOptions` | Override Better Auth options (merged with defaults) | [src/convex/client/index.ts:594](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L594) |
| <a id="basepath"></a> `basePath?` | `string` | Override Better Auth basePath and matching Convex auth route | [src/convex/client/index.ts:596](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L596) |
| <a id="admin"></a> `admin?` | `false` \| `AdminOptions` | Admin plugin options (roles via `adminRoles`/`ac`, ban, impersonation). Enabled by default; pass `false` to disable — a disabled plugin still leaves its (optional) schema fields in place. | [src/convex/client/index.ts:602](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L602) |
| <a id="organization"></a> `organization?` | \| `false` \| `OrganizationOptions` & \{ `personal?`: `boolean`; `invitationPath?`: `string`; \} | Organization (workspace) plugin options. Enabled by default with a personal workspace per user (`personal: true`); pass `false` to disable. | [src/convex/client/index.ts:607](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L607) |
| <a id="mcp"></a> `mcp?` | `false` \| [`McpAuthOptions`](#mcpauthoptions) | Agent (MCP) OAuth provider options. Enabled by default — apps built on this package expose an OAuth-protected MCP endpoint out of the box; pass `false` to disable the provider (and the `/mcp/exchange` token mint). | [src/convex/client/index.ts:613](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L613) |

***

### SetupAuthOptions

Defined in: [src/convex/client/index.ts:616](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L616)
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="authconfig-1"></a> `authConfig?` | `AuthConfig` | Override the default auth config (e.g. to add custom providers) | [`CreateBetterAuthOptions`](#createbetterauthoptions).[`authConfig`](#authconfig) | [src/convex/client/index.ts:592](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L592) |
| <a id="authoptions-1"></a> `authOptions?` | `BetterAuthOptions` | Override Better Auth options (merged with defaults) | [`CreateBetterAuthOptions`](#createbetterauthoptions).[`authOptions`](#authoptions) | [src/convex/client/index.ts:594](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L594) |
| <a id="basepath-1"></a> `basePath?` | `string` | Override Better Auth basePath and matching Convex auth route | [`CreateBetterAuthOptions`](#createbetterauthoptions).[`basePath`](#basepath) | [src/convex/client/index.ts:596](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L596) |
| <a id="admin-1"></a> `admin?` | `false` \| `AdminOptions` | Admin plugin options (roles via `adminRoles`/`ac`, ban, impersonation). Enabled by default; pass `false` to disable — a disabled plugin still leaves its (optional) schema fields in place. | [`CreateBetterAuthOptions`](#createbetterauthoptions).[`admin`](#admin) | [src/convex/client/index.ts:602](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L602) |
| <a id="organization-1"></a> `organization?` | \| `false` \| `OrganizationOptions` & \{ `personal?`: `boolean`; `invitationPath?`: `string`; \} | Organization (workspace) plugin options. Enabled by default with a personal workspace per user (`personal: true`); pass `false` to disable. | [`CreateBetterAuthOptions`](#createbetterauthoptions).[`organization`](#organization) | [src/convex/client/index.ts:607](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L607) |
| <a id="mcp-1"></a> `mcp?` | `false` \| [`McpAuthOptions`](#mcpauthoptions) | Agent (MCP) OAuth provider options. Enabled by default — apps built on this package expose an OAuth-protected MCP endpoint out of the box; pass `false` to disable the provider (and the `/mcp/exchange` token mint). | [`CreateBetterAuthOptions`](#createbetterauthoptions).[`mcp`](#mcp) | [src/convex/client/index.ts:613](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L613) |
| <a id="schema-1"></a> `schema?` | `Schema` | Local Better Auth schema for hybrid/local component installs | - | [src/convex/client/index.ts:621](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L621) |
| <a id="verbose"></a> `verbose?` | `boolean` | Enable verbose logs in the Better Auth Convex component client | - | [src/convex/client/index.ts:623](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L623) |
| <a id="integrations"></a> `integrations?` | [`AuthIntegrations`](#authintegrations)\<`DM`\> | Cross-component wiring: an email transport for auth emails, a rate limiter for OTP sends, a `canSignIn` gate, and the `onUserCreated` / `onUserDeleted` lifecycle hooks. See [AuthIntegrations](#authintegrations). | - | [src/convex/client/index.ts:629](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L629) |

***

### AuthSetupComponents

Defined in: [src/convex/client/index.ts:646](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L646)
...
| Property | Type | Defined in |
| ------ | ------ | ------ |
| <a id="backend"></a> `backend` | `PublicAuthComponentRef` | [src/convex/client/index.ts:647](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L647) |
...
Defined in: [src/convex/client/index.ts:74](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L74)
...
Defined in: [src/convex/client/index.ts:104](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L104)
...
Defined in: [src/convex/client/index.ts:120](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L120)
...
Defined in: [src/convex/client/index.ts:133](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L133)
...
Defined in: [src/convex/client/index.ts:148](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L148)
...
Defined in: [src/convex/client/index.ts:158](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L158)
...
Defined in: [src/convex/client/index.ts:540](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L540)
...
Defined in: [src/convex/client/index.ts:555](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L555)
...
| ------ | ------ | ------ |
| `personal?` | `boolean` | [src/convex/client/index.ts:556](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L556) |
| `invitationPath?` | `string` | [src/convex/client/index.ts:557](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L557) |
...
Defined in: [src/convex/client/index.ts:290](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L290)
...
Defined in: [src/convex/client/index.ts:859](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L859)
...
| `basePath` | `string` | `resolvedBasePath` | - | [src/convex/client/index.ts:1075](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1075) |
| `database` | `AdapterFactory`\<`BetterAuthOptions`\> | - | - | [src/convex/client/index.ts:1076](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1076) |
| `emailAndPassword` | \{ `disableSignUp?`: `boolean`; `requireEmailVerification?`: `boolean`; `maxPasswordLength?`: `number`; `minPasswordLength?`: `number`; `sendResetPassword?`: (`data`, `request?`) => `Promise`\<`void`\>; `resetPasswordTokenExpiresIn?`: `number`; `onPasswordReset?`: (`data`, `request?`) => `Promise`\<`void`\>; `password?`: \{ `hash?`: (`password`) => `Promise`\<`string`\>; `verify?`: (`data`) => `Promise`\<`boolean`\>; \}; `autoSignIn?`: `boolean`; `revokeSessionsOnPasswordReset?`: `boolean`; `onExistingUserSignUp?`: (`data`, `request?`) => `Promise`\<`void`\>; `customSyntheticUser?`: (`params`) => `Record`\<`string`, `unknown`\>; `enabled`: `boolean`; \} | - | - | [src/convex/client/index.ts:1078](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1078) |
...
| `emailAndPassword.enabled` | `boolean` | `false` | Enable email and password authentication **Default** `false` | [src/convex/client/index.ts:1079](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1079) |
| `user` | \{ `modelName?`: `"user"` \| `LiteralString`; `fields?`: `Partial`\<`Record`\<`"createdAt"` \| `"updatedAt"` \| `"email"` \| `"emailVerified"` \| `"name"` \| `"image"`, `string`\>\>; `additionalFields?`: \{ \[`key`: `string`\]: `DBFieldAttribute`; \}; `changeEmail?`: \{ `enabled`: `boolean`; `sendChangeEmailConfirmation?`: (`data`, `request?`) => `Promise`\<`void`\>; `updateEmailWithoutVerification?`: `boolean`; \}; `deleteUser?`: \{ `enabled?`: `boolean`; `sendDeleteAccountVerification?`: (`data`, `request?`) => `Promise`\<`void`\>; `beforeDelete?`: (`user`, `request?`) => `Promise`\<`void`\>; `afterDelete?`: (`user`, `request?`) => `Promise`\<`void`\>; `deleteTokenExpiresIn?`: `number`; \}; \} | - | - | [src/convex/client/index.ts:1084](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1084) |
...
Defined in: [src/convex/client/index.ts:1181](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1181)
...
Defined in: [src/convex/client/index.ts:1188](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1188)
...
Defined in: [src/convex/client/index.ts:1215](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1215)
...
Defined in: [src/convex/client/index.ts:1261](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1261)
...
| Name | Type | Defined in |
| ------ | ------ | ------ |
| `getAuthUser` | `RegisteredQuery`\<`"public"`, \{ \}, `Promise`\<`MaybeMakeLooseDataModel`\<\{ \[TableName in string\]: Schema\["tables"\]\[TableName\] extends TableDefinition\<DocumentType, Indexes, SearchIndexes, VectorIndexes\> ? \{ document: Expand\<(...) & (...)\>; fieldPaths: "\_id" \| ExtractFieldPaths\<(...)\>; indexes: Expand\<(...) & (...)\>; searchIndexes: SearchIndexes; vectorIndexes: VectorIndexes \} : never \}, `Schema`\[`"strictTableNameTypes"`\]\>\[`"user"`\]\[`"document"`\]\>\> | [src/convex/client/index.ts:1394](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1394) |
| `authConfig` | `RegisteredQuery`\<`"public"`, \{ \}, `Promise`\<\{ `invitationPath`: `string` \| `null`; \}\>\> | [src/convex/client/index.ts:1395](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1395) |
| `listWorkspaces` | `RegisteredQuery`\<`"public"`, \{ \}, `Promise`\< \| \{ `id`: `string`; `name`: `string`; `slug`: `string`; `logo`: `string` \| `null`; `role`: `string`; `active`: `boolean`; `joinedAt`: `number`; \}[] \| `null`\>\> | [src/convex/client/index.ts:1396](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1396) |
| `listWorkspaceMembers` | `RegisteredQuery`\<`"public"`, \{ `organizationId?`: `string`; \}, `Promise`\< \| \{ `organizationId`: `string`; `members`: \{ `userId`: `string`; `name`: `string`; `email`: `string`; `role`: `string`; `joinedAt`: `number`; \}[]; \} \| `null`\>\> | [src/convex/client/index.ts:1397](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1397) |
| `updateProfile` | `RegisteredMutation`\<`"public"`, \{ `name`: `string`; \}, `Promise`\<`null`\>\> | [src/convex/client/index.ts:1398](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1398) |
...
Defined in: [src/convex/client/index.ts:1419](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1419)
...
| `options.basePath` | `string` | `resolvedBasePath` | - | [src/convex/client/index.ts:1075](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1075) |
| `options.database` | `AdapterFactory`\<`BetterAuthOptions`\> | - | - | [src/convex/client/index.ts:1076](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1076) |
...
| `options.emailAndPassword.enabled` | `boolean` | `false` | Enable email and password authentication **Default** `false` | [src/convex/client/index.ts:1079](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1079) |
