---
title: "convex/client"
description: "API reference for nuxt-backend/auth."
navigation:
  title: "client"
...
Defined in: [src/convex/client/index.ts:579](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L579)
...
| Property | Type | Description | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="scopes"></a> `scopes?` | `string`[] | Extra OAuth scopes on top of the built-in set, `BACKEND_MCP_SCOPES` (identity scopes plus the built-in tool scopes, always offered). | [src/convex/client/index.ts:584](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L584) |
| <a id="loginpage"></a> `loginPage?` | `string` | The app page agents' users sign in on mid-OAuth. Defaults to the built-in login page path; align with `backend.pages.login` / `backend.loginPath` when those are customized. | [src/convex/client/index.ts:590](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L590) |
| <a id="consentpage"></a> `consentPage?` | `string` | Your own consent page path; the plugin's built-in screen when unset. | [src/convex/client/index.ts:592](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L592) |
| <a id="trustedclients"></a> `trustedClients?` | `Client`[] | Pre-registered clients (e.g. first-party agents with `skipConsent`). | [src/convex/client/index.ts:594](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L594) |
| <a id="oidcconfig"></a> `oidcConfig?` | `OIDCOptions` | Advanced OIDC provider passthrough; the options above win over it. | [src/convex/client/index.ts:596](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L596) |

***

### CreateBetterAuthOptions

Defined in: [src/convex/client/index.ts:599](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L599)
...
| Property | Type | Description | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="authconfig"></a> `authConfig?` | `AuthConfig` | Override the default auth config (e.g. to add custom providers) | [src/convex/client/index.ts:601](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L601) |
| <a id="authoptions"></a> `authOptions?` | `BetterAuthOptions` | Override Better Auth options (merged with defaults) | [src/convex/client/index.ts:603](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L603) |
| <a id="basepath"></a> `basePath?` | `string` | Override Better Auth basePath and matching Convex auth route | [src/convex/client/index.ts:605](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L605) |
| <a id="admin"></a> `admin?` | `false` \| `AdminOptions` | Admin plugin options (roles via `adminRoles`/`ac`, ban, impersonation). Enabled by default; pass `false` to disable — a disabled plugin still leaves its (optional) schema fields in place. | [src/convex/client/index.ts:611](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L611) |
| <a id="organization"></a> `organization?` | \| `false` \| `OrganizationOptions` & \{ `personal?`: `boolean`; `invitationPath?`: `string`; \} | Organization (workspace) plugin options. Enabled by default with a personal workspace per user (`personal: true`); pass `false` to disable. | [src/convex/client/index.ts:616](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L616) |
| <a id="mcp"></a> `mcp?` | `false` \| [`McpAuthOptions`](#mcpauthoptions) | Agent (MCP) OAuth provider options. Enabled by default — apps built on this package expose an OAuth-protected MCP endpoint out of the box; pass `false` to disable the provider (and the `/mcp/exchange` token mint). | [src/convex/client/index.ts:622](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L622) |

***

### SetupAuthOptions

Defined in: [src/convex/client/index.ts:625](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L625)
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="authconfig-1"></a> `authConfig?` | `AuthConfig` | Override the default auth config (e.g. to add custom providers) | [`CreateBetterAuthOptions`](#createbetterauthoptions).[`authConfig`](#authconfig) | [src/convex/client/index.ts:601](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L601) |
| <a id="authoptions-1"></a> `authOptions?` | `BetterAuthOptions` | Override Better Auth options (merged with defaults) | [`CreateBetterAuthOptions`](#createbetterauthoptions).[`authOptions`](#authoptions) | [src/convex/client/index.ts:603](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L603) |
| <a id="basepath-1"></a> `basePath?` | `string` | Override Better Auth basePath and matching Convex auth route | [`CreateBetterAuthOptions`](#createbetterauthoptions).[`basePath`](#basepath) | [src/convex/client/index.ts:605](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L605) |
| <a id="admin-1"></a> `admin?` | `false` \| `AdminOptions` | Admin plugin options (roles via `adminRoles`/`ac`, ban, impersonation). Enabled by default; pass `false` to disable — a disabled plugin still leaves its (optional) schema fields in place. | [`CreateBetterAuthOptions`](#createbetterauthoptions).[`admin`](#admin) | [src/convex/client/index.ts:611](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L611) |
| <a id="organization-1"></a> `organization?` | \| `false` \| `OrganizationOptions` & \{ `personal?`: `boolean`; `invitationPath?`: `string`; \} | Organization (workspace) plugin options. Enabled by default with a personal workspace per user (`personal: true`); pass `false` to disable. | [`CreateBetterAuthOptions`](#createbetterauthoptions).[`organization`](#organization) | [src/convex/client/index.ts:616](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L616) |
| <a id="mcp-1"></a> `mcp?` | `false` \| [`McpAuthOptions`](#mcpauthoptions) | Agent (MCP) OAuth provider options. Enabled by default — apps built on this package expose an OAuth-protected MCP endpoint out of the box; pass `false` to disable the provider (and the `/mcp/exchange` token mint). | [`CreateBetterAuthOptions`](#createbetterauthoptions).[`mcp`](#mcp) | [src/convex/client/index.ts:622](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L622) |
| <a id="schema-1"></a> `schema?` | `Schema` | Local Better Auth schema for hybrid/local component installs | - | [src/convex/client/index.ts:630](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L630) |
| <a id="verbose"></a> `verbose?` | `boolean` | Enable verbose logs in the Better Auth Convex component client | - | [src/convex/client/index.ts:632](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L632) |
| <a id="integrations"></a> `integrations?` | [`AuthIntegrations`](#authintegrations)\<`DM`\> | Cross-component wiring: an email transport for auth emails, a rate limiter for OTP sends, a `canSignIn` gate, and the `onUserCreated` / `onUserDeleted` lifecycle hooks. See [AuthIntegrations](#authintegrations). | - | [src/convex/client/index.ts:638](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L638) |

***

### AuthSetupComponents

Defined in: [src/convex/client/index.ts:655](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L655)
...
| Property | Type | Defined in |
| ------ | ------ | ------ |
| <a id="backend"></a> `backend` | `PublicAuthComponentRef` | [src/convex/client/index.ts:656](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L656) |
...
Defined in: [src/convex/client/index.ts:549](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L549)
...
Defined in: [src/convex/client/index.ts:564](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L564)
...
| ------ | ------ | ------ |
| `personal?` | `boolean` | [src/convex/client/index.ts:565](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L565) |
| `invitationPath?` | `string` | [src/convex/client/index.ts:566](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L566) |
...
Defined in: [src/convex/client/index.ts:868](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L868)
...
| `basePath` | `string` | `resolvedBasePath` | - | [src/convex/client/index.ts:1087](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1087) |
| `database` | `AdapterFactory`\<`BetterAuthOptions`\> | - | - | [src/convex/client/index.ts:1088](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1088) |
| `emailAndPassword` | \{ `disableSignUp?`: `boolean`; `requireEmailVerification?`: `boolean`; `maxPasswordLength?`: `number`; `minPasswordLength?`: `number`; `sendResetPassword?`: (`data`, `request?`) => `Promise`\<`void`\>; `resetPasswordTokenExpiresIn?`: `number`; `onPasswordReset?`: (`data`, `request?`) => `Promise`\<`void`\>; `password?`: \{ `hash?`: (`password`) => `Promise`\<`string`\>; `verify?`: (`data`) => `Promise`\<`boolean`\>; \}; `autoSignIn?`: `boolean`; `revokeSessionsOnPasswordReset?`: `boolean`; `onExistingUserSignUp?`: (`data`, `request?`) => `Promise`\<`void`\>; `customSyntheticUser?`: (`params`) => `Record`\<`string`, `unknown`\>; `enabled`: `boolean`; \} | - | - | [src/convex/client/index.ts:1090](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1090) |
...
| `emailAndPassword.enabled` | `boolean` | `false` | Enable email and password authentication **Default** `false` | [src/convex/client/index.ts:1091](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1091) |
| `user` | \{ `modelName?`: `"user"` \| `LiteralString`; `fields?`: `Partial`\<`Record`\<`"createdAt"` \| `"updatedAt"` \| `"email"` \| `"emailVerified"` \| `"name"` \| `"image"`, `string`\>\>; `additionalFields?`: \{ \[`key`: `string`\]: `DBFieldAttribute`; \}; `changeEmail?`: \{ `enabled`: `boolean`; `sendChangeEmailConfirmation?`: (`data`, `request?`) => `Promise`\<`void`\>; `updateEmailWithoutVerification?`: `boolean`; \}; `deleteUser?`: \{ `enabled?`: `boolean`; `sendDeleteAccountVerification?`: (`data`, `request?`) => `Promise`\<`void`\>; `beforeDelete?`: (`user`, `request?`) => `Promise`\<`void`\>; `afterDelete?`: (`user`, `request?`) => `Promise`\<`void`\>; `deleteTokenExpiresIn?`: `number`; \}; \} | - | - | [src/convex/client/index.ts:1096](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1096) |
...
Defined in: [src/convex/client/index.ts:1200](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1200)
...
Defined in: [src/convex/client/index.ts:1227](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1227)
...
Defined in: [src/convex/client/index.ts:1273](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1273)
...
| Name | Type | Defined in |
| ------ | ------ | ------ |
| `getAuthUser` | `RegisteredQuery`\<`"public"`, \{ \}, `Promise`\<`MaybeMakeLooseDataModel`\<\{ \[TableName in string\]: Schema\["tables"\]\[TableName\] extends TableDefinition\<DocumentType, Indexes, SearchIndexes, VectorIndexes\> ? \{ document: Expand\<(...) & (...)\>; fieldPaths: "\_id" \| ExtractFieldPaths\<(...)\>; indexes: Expand\<(...) & (...)\>; searchIndexes: SearchIndexes; vectorIndexes: VectorIndexes \} : never \}, `Schema`\[`"strictTableNameTypes"`\]\>\[`"user"`\]\[`"document"`\]\>\> | [src/convex/client/index.ts:1406](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1406) |
| `authConfig` | `RegisteredQuery`\<`"public"`, \{ \}, `Promise`\<\{ `invitationPath`: `string` \| `null`; \}\>\> | [src/convex/client/index.ts:1407](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1407) |
| `listWorkspaces` | `RegisteredQuery`\<`"public"`, \{ \}, `Promise`\< \| \{ `id`: `string`; `name`: `string`; `slug`: `string`; `logo`: `string` \| `null`; `role`: `string`; `active`: `boolean`; `joinedAt`: `number`; \}[] \| `null`\>\> | [src/convex/client/index.ts:1408](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1408) |
| `listWorkspaceMembers` | `RegisteredQuery`\<`"public"`, \{ `organizationId?`: `string`; \}, `Promise`\< \| \{ `organizationId`: `string`; `members`: \{ `userId`: `string`; `name`: `string`; `email`: `string`; `role`: `string`; `joinedAt`: `number`; \}[]; \} \| `null`\>\> | [src/convex/client/index.ts:1409](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1409) |
| `updateProfile` | `RegisteredMutation`\<`"public"`, \{ `name`: `string`; \}, `Promise`\<`null`\>\> | [src/convex/client/index.ts:1410](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1410) |
...
Defined in: [src/convex/client/index.ts:1431](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1431)
...
| `authComponent.triggersApi()` | () => \{ `onCreate`: `RegisteredMutation`\<`"internal"`, \{ `model`: `string`; `doc`: `any`; \}, `Promise`\<`void`\>\>; `onUpdate`: `RegisteredMutation`\<`"internal"`, \{ `model`: `string`; `oldDoc`: `any`; `newDoc`: `any`; \}, `Promise`\<`void`\>\>; `onDelete`: `RegisteredMutation`\<`"internal"`, \{ `model`: `string`; `doc`: `any`; \}, `Promise`\<`void`\>\>; \} | - | Exposes functions for executing trigger callbacks in the app context. Callbacks are defined in the `triggers` option to the component client config. See [createClient](https://labs.convex.dev/better-auth) for more information. | node\_modules/@convex-dev/better-auth/dist/client/create-client.d.ts:168 |
...
| `options.basePath` | `string` | `resolvedBasePath` | - | [src/convex/client/index.ts:1087](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1087) |
| `options.database` | `AdapterFactory`\<`BetterAuthOptions`\> | - | - | [src/convex/client/index.ts:1088](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1088) |
...
| `options.emailAndPassword.enabled` | `boolean` | `false` | Enable email and password authentication **Default** `false` | [src/convex/client/index.ts:1091](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1091) |
