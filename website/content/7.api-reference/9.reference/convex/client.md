...
| Property | Type | Description | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="scopes"></a> `scopes?` | `string`[] | Extra OAuth scopes on top of the built-in set, `BACKEND_MCP_SCOPES` (identity scopes plus the built-in tool scopes, always offered). | [src/convex/client/index.ts:575](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L575) |
