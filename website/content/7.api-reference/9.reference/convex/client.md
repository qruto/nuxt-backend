...
| Property | Type | Description | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="scopes"></a> `scopes?` | `string`[] | Extra OAuth scopes on top of BACKEND\_MCP\_SCOPES (identity scopes plus the built-in tool scopes, always offered). | [src/convex/client/index.ts:472](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L472) |
| <a id="loginpage"></a> `loginPage?` | `string` | The app page agents' users sign in on mid-OAuth. Defaults to the built-in login page path; align with `backend.pages.login` / `backend.loginPath` when those are customized. | [src/convex/client/index.ts:478](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L478) |
| <a id="consentpage"></a> `consentPage?` | `string` | Your own consent page path; the plugin's built-in screen when unset. | [src/convex/client/index.ts:480](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L480) |
| <a id="trustedclients"></a> `trustedClients?` | `Client`[] | Pre-registered clients (e.g. first-party agents with `skipConsent`). | [src/convex/client/index.ts:482](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L482) |
| <a id="oidcconfig"></a> `oidcConfig?` | `OIDCOptions` | Advanced OIDC provider passthrough; the options above win over it. | [src/convex/client/index.ts:484](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L484) |

***

### CreateBetterAuthOptions

Defined in: [src/convex/client/index.ts:487](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L487)
...
| Property | Type | Description | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="authconfig"></a> `authConfig?` | `AuthConfig` | Override the default auth config (e.g. to add custom providers) | [src/convex/client/index.ts:489](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L489) |
| <a id="authoptions"></a> `authOptions?` | `BetterAuthOptions` | Override Better Auth options (merged with defaults) | [src/convex/client/index.ts:491](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L491) |
| <a id="basepath"></a> `basePath?` | `string` | Override Better Auth basePath and matching Convex auth route | [src/convex/client/index.ts:493](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L493) |
| <a id="admin"></a> `admin?` | `false` \| `AdminOptions` | Admin plugin options (roles via `adminRoles`/`ac`, ban, impersonation). Enabled by default; pass `false` to disable — a disabled plugin still leaves its (optional) schema fields in place. | [src/convex/client/index.ts:499](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L499) |
| <a id="organization"></a> `organization?` | \| `false` \| `OrganizationOptions` & \{ `personal?`: `boolean`; `invitationPath?`: `string`; \} | Organization (workspace) plugin options. Enabled by default with a personal workspace per user (`personal: true`); pass `false` to disable. | [src/convex/client/index.ts:504](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L504) |
| <a id="mcp"></a> `mcp?` | `false` \| [`McpAuthOptions`](#mcpauthoptions) | Agent (MCP) OAuth provider options. Enabled by default — apps built on this package expose an OAuth-protected MCP endpoint out of the box; pass `false` to disable the provider (and the `/mcp/exchange` token mint). | [src/convex/client/index.ts:510](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L510) |

***

### SetupAuthOptions

Defined in: [src/convex/client/index.ts:513](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L513)
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="authconfig-1"></a> `authConfig?` | `AuthConfig` | Override the default auth config (e.g. to add custom providers) | [`CreateBetterAuthOptions`](#createbetterauthoptions).[`authConfig`](#authconfig) | [src/convex/client/index.ts:489](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L489) |
| <a id="authoptions-1"></a> `authOptions?` | `BetterAuthOptions` | Override Better Auth options (merged with defaults) | [`CreateBetterAuthOptions`](#createbetterauthoptions).[`authOptions`](#authoptions) | [src/convex/client/index.ts:491](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L491) |
| <a id="basepath-1"></a> `basePath?` | `string` | Override Better Auth basePath and matching Convex auth route | [`CreateBetterAuthOptions`](#createbetterauthoptions).[`basePath`](#basepath) | [src/convex/client/index.ts:493](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L493) |
| <a id="admin-1"></a> `admin?` | `false` \| `AdminOptions` | Admin plugin options (roles via `adminRoles`/`ac`, ban, impersonation). Enabled by default; pass `false` to disable — a disabled plugin still leaves its (optional) schema fields in place. | [`CreateBetterAuthOptions`](#createbetterauthoptions).[`admin`](#admin) | [src/convex/client/index.ts:499](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L499) |
| <a id="organization-1"></a> `organization?` | \| `false` \| `OrganizationOptions` & \{ `personal?`: `boolean`; `invitationPath?`: `string`; \} | Organization (workspace) plugin options. Enabled by default with a personal workspace per user (`personal: true`); pass `false` to disable. | [`CreateBetterAuthOptions`](#createbetterauthoptions).[`organization`](#organization) | [src/convex/client/index.ts:504](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L504) |
| <a id="mcp-1"></a> `mcp?` | `false` \| [`McpAuthOptions`](#mcpauthoptions) | Agent (MCP) OAuth provider options. Enabled by default — apps built on this package expose an OAuth-protected MCP endpoint out of the box; pass `false` to disable the provider (and the `/mcp/exchange` token mint). | [`CreateBetterAuthOptions`](#createbetterauthoptions).[`mcp`](#mcp) | [src/convex/client/index.ts:510](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L510) |
| <a id="schema-1"></a> `schema?` | `Schema` | Local Better Auth schema for hybrid/local component installs | - | [src/convex/client/index.ts:518](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L518) |
| <a id="verbose"></a> `verbose?` | `boolean` | Enable verbose logs in the Better Auth Convex component client | - | [src/convex/client/index.ts:520](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L520) |
| <a id="integrations"></a> `integrations?` | [`AuthIntegrations`](#authintegrations)\<`DM`\> | Cross-component wiring: an email transport for auth emails, a rate limiter for OTP sends, a `canSignIn` gate, and the `onUserCreated` / `onUserDeleted` lifecycle hooks. See [AuthIntegrations](#authintegrations). | - | [src/convex/client/index.ts:526](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L526) |

***

### AuthSetupComponents

Defined in: [src/convex/client/index.ts:543](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L543)
...
| Property | Type | Defined in |
| ------ | ------ | ------ |
| <a id="backend"></a> `backend` | `PublicAuthComponentRef` | [src/convex/client/index.ts:544](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L544) |
...
Defined in: [src/convex/client/index.ts:437](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L437)
...
Defined in: [src/convex/client/index.ts:452](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L452)
...
| ------ | ------ | ------ |
| `personal?` | `boolean` | [src/convex/client/index.ts:453](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L453) |
| `invitationPath?` | `string` | [src/convex/client/index.ts:454](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L454) |
...
Defined in: [src/convex/client/index.ts:744](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L744)
...
| `basePath` | `string` | `resolvedBasePath` | - | [src/convex/client/index.ts:960](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L960) |
| `database` | `AdapterFactory`\<`BetterAuthOptions`\> | - | - | [src/convex/client/index.ts:961](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L961) |
| `emailAndPassword` | \{ `disableSignUp?`: `boolean`; `requireEmailVerification?`: `boolean`; `maxPasswordLength?`: `number`; `minPasswordLength?`: `number`; `sendResetPassword?`: (`data`, `request?`) => `Promise`\<`void`\>; `resetPasswordTokenExpiresIn?`: `number`; `onPasswordReset?`: (`data`, `request?`) => `Promise`\<`void`\>; `password?`: \{ `hash?`: (`password`) => `Promise`\<`string`\>; `verify?`: (`data`) => `Promise`\<`boolean`\>; \}; `autoSignIn?`: `boolean`; `revokeSessionsOnPasswordReset?`: `boolean`; `onExistingUserSignUp?`: (`data`, `request?`) => `Promise`\<`void`\>; `customSyntheticUser?`: (`params`) => `Record`\<`string`, `unknown`\>; `enabled`: `boolean`; \} | - | - | [src/convex/client/index.ts:963](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L963) |
...
| `emailAndPassword.enabled` | `boolean` | `false` | Enable email and password authentication **Default** `false` | [src/convex/client/index.ts:964](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L964) |
| `user` | \{ `modelName?`: `"user"` \| `LiteralString`; `fields?`: `Partial`\<`Record`\<`"createdAt"` \| `"updatedAt"` \| `"email"` \| `"emailVerified"` \| `"name"` \| `"image"`, `string`\>\>; `additionalFields?`: \{ \[`key`: `string`\]: `DBFieldAttribute`; \}; `changeEmail?`: \{ `enabled`: `boolean`; `sendChangeEmailConfirmation?`: (`data`, `request?`) => `Promise`\<`void`\>; `updateEmailWithoutVerification?`: `boolean`; \}; `deleteUser?`: \{ `enabled?`: `boolean`; `sendDeleteAccountVerification?`: (`data`, `request?`) => `Promise`\<`void`\>; `beforeDelete?`: (`user`, `request?`) => `Promise`\<`void`\>; `afterDelete?`: (`user`, `request?`) => `Promise`\<`void`\>; `deleteTokenExpiresIn?`: `number`; \}; \} | - | - | [src/convex/client/index.ts:969](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L969) |
...
Defined in: [src/convex/client/index.ts:1066](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1066)
...
Defined in: [src/convex/client/index.ts:1073](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1073)
...
Defined in: [src/convex/client/index.ts:1100](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1100)
...
Defined in: [src/convex/client/index.ts:1146](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1146)
...
| Name | Type | Defined in |
| ------ | ------ | ------ |
| `getAuthUser` | `RegisteredQuery`\<`"public"`, \{ \}, `Promise`\<`MaybeMakeLooseDataModel`\<\{ \[TableName in string\]: Schema\["tables"\]\[TableName\] extends TableDefinition\<DocumentType, Indexes, SearchIndexes, VectorIndexes\> ? \{ document: Expand\<(...) & (...)\>; fieldPaths: "\_id" \| ExtractFieldPaths\<(...)\>; indexes: Expand\<(...) & (...)\>; searchIndexes: SearchIndexes; vectorIndexes: VectorIndexes \} : never \}, `Schema`\[`"strictTableNameTypes"`\]\>\[`"user"`\]\[`"document"`\]\>\> | [src/convex/client/index.ts:1279](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1279) |
| `authConfig` | `RegisteredQuery`\<`"public"`, \{ \}, `Promise`\<\{ `invitationPath`: `string` \| `null`; \}\>\> | [src/convex/client/index.ts:1280](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1280) |
| `listWorkspaces` | `RegisteredQuery`\<`"public"`, \{ \}, `Promise`\< \| \{ `id`: `string`; `name`: `string`; `slug`: `string`; `logo`: `string` \| `null`; `role`: `string`; `active`: `boolean`; `joinedAt`: `number`; \}[] \| `null`\>\> | [src/convex/client/index.ts:1281](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1281) |
| `listWorkspaceMembers` | `RegisteredQuery`\<`"public"`, \{ `organizationId?`: `string`; \}, `Promise`\< \| \{ `organizationId`: `string`; `members`: \{ `userId`: `string`; `name`: `string`; `email`: `string`; `role`: `string`; `joinedAt`: `number`; \}[]; \} \| `null`\>\> | [src/convex/client/index.ts:1282](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1282) |
| `updateProfile` | `RegisteredMutation`\<`"public"`, \{ `name`: `string`; \}, `Promise`\<`null`\>\> | [src/convex/client/index.ts:1283](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1283) |
...
Defined in: [src/convex/client/index.ts:1304](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1304)
...
| `options.basePath` | `string` | `resolvedBasePath` | - | [src/convex/client/index.ts:960](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L960) |
| `options.database` | `AdapterFactory`\<`BetterAuthOptions`\> | - | - | [src/convex/client/index.ts:961](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L961) |
...
| `options.emailAndPassword.enabled` | `boolean` | `false` | Enable email and password authentication **Default** `false` | [src/convex/client/index.ts:964](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L964) |
