...
Defined in: [src/convex/client/index.ts:82](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L82)
...
Defined in: [src/convex/client/index.ts:90](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L90)
...
| Property | Type | Defined in |
| ------ | ------ | ------ |
| <a id="id"></a> `id` | `string` | [src/convex/client/index.ts:91](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L91) |
| <a id="email"></a> `email` | `string` | [src/convex/client/index.ts:92](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L92) |
| <a id="name"></a> `name` | `string` | [src/convex/client/index.ts:93](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L93) |

***

### AuthDeletedUser

Defined in: [src/convex/client/index.ts:105](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L105)
...
| Property | Type | Defined in |
| ------ | ------ | ------ |
| <a id="id-1"></a> `id` | `string` | [src/convex/client/index.ts:106](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L106) |
| <a id="email-1"></a> `email` | `string` | [src/convex/client/index.ts:107](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L107) |
| <a id="name-1"></a> `name` | `string` | [src/convex/client/index.ts:108](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L108) |
...
| ------ | ------ | ------ | ------ |
| <a id="email-2"></a> `email` | `string` | The address, as Better Auth holds it (lower-cased). | [src/convex/client/index.ts:135](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L135) |
| <a id="isnewuser"></a> `isNewUser` | `boolean` | `true` when no account exists for the address yet. | [src/convex/client/index.ts:137](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L137) |
| <a id="purpose"></a> `purpose` | [`CanSignInPurpose`](#cansigninpurpose) | - | [src/convex/client/index.ts:138](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L138) |

***

### AuthIntegrations

Defined in: [src/convex/client/index.ts:167](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L167)
...
| Property | Type | Description | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="email-3"></a> `email?` | [`AuthEmailSender`](#authemailsender) | - | [src/convex/client/index.ts:168](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L168) |
| <a id="ratelimiter"></a> `rateLimiter?` | [`AuthRateLimiter`](#authratelimiter) | - | [src/convex/client/index.ts:169](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L169) |
| <a id="onusercreated-1"></a> `onUserCreated?` | [`OnUserCreated`](#onusercreated)\<`DM`\> | - | [src/convex/client/index.ts:170](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L170) |
| <a id="cansignin-1"></a> `canSignIn?` | [`CanSignIn`](#cansignin)\<`DM`\> | Gate sign-in / sign-up (invite-only, allow-list, closed beta). See [CanSignIn](#cansignin). | [src/convex/client/index.ts:172](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L172) |
| <a id="onuserdeleted-1"></a> `onUserDeleted?` | [`OnUserDeleted`](#onuserdeleted)\<`DM`\> | Fired after an account is deleted, after any consumer `afterDelete`. See [OnUserDeleted](#onuserdeleted). | [src/convex/client/index.ts:174](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L174) |
| <a id="emailtemplates"></a> `emailTemplates?` | `Partial`\<[`AuthEmailTemplates`](#authemailtemplates)\> | Override any of the default auth-email templates (welcome/otp/verify/change/delete/invite). | [src/convex/client/index.ts:176](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L176) |
| <a id="welcomeemail"></a> `welcomeEmail?` | `boolean` | Send the packaged welcome email right after signup (default `true`). Set `false` when the app owns onboarding — e.g. a durable email sequence started from `onUserCreated` — so new users don't get two welcomes. | [src/convex/client/index.ts:182](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L182) |

***

### AuthEmailTemplates

Defined in: [src/convex/client/index.ts:258](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L258)
...
| Property | Type | Description | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="otp"></a> `otp` | (`data`) => [`AuthEmailMessage`](#authemailmessage) | OTP code email (sign-in / email-verification / change-email). | [src/convex/client/index.ts:260](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L260) |
| <a id="welcome"></a> `welcome` | (`data`) => [`AuthEmailMessage`](#authemailmessage) | Welcome email sent once, right after a user is created. | [src/convex/client/index.ts:262](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L262) |
| <a id="verify"></a> `verify` | (`data`) => [`AuthEmailMessage`](#authemailmessage) | Email-verification link (when verification is enabled). | [src/convex/client/index.ts:264](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L264) |
| <a id="changeemail"></a> `changeEmail` | (`data`) => [`AuthEmailMessage`](#authemailmessage) | Confirmation sent to the current address when changing email. | [src/convex/client/index.ts:266](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L266) |
| <a id="deleteaccount"></a> `deleteAccount` | (`data`) => [`AuthEmailMessage`](#authemailmessage) | Confirmation link for account deletion. | [src/convex/client/index.ts:268](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L268) |
| <a id="invite"></a> `invite` | (`data`) => [`AuthEmailMessage`](#authemailmessage) | Workspace invitation with an accept link (organization plugin). | [src/convex/client/index.ts:270](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L270) |

***

### McpAuthOptions

Defined in: [src/convex/client/index.ts:471](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L471)
...
| Property | Type | Description | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="scopes"></a> `scopes?` | `string`[] | Extra OAuth scopes on top of BACKEND\_MCP\_SCOPES (identity scopes plus the built-in tool scopes, always offered). | [src/convex/client/index.ts:476](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L476) |
| <a id="loginpage"></a> `loginPage?` | `string` | The app page agents' users sign in on mid-OAuth. Defaults to the built-in login page path; align with `backend.pages.login` / `backend.loginPath` when those are customized. | [src/convex/client/index.ts:482](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L482) |
| <a id="consentpage"></a> `consentPage?` | `string` | Your own consent page path; the plugin's built-in screen when unset. | [src/convex/client/index.ts:484](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L484) |
| <a id="trustedclients"></a> `trustedClients?` | `Client`[] | Pre-registered clients (e.g. first-party agents with `skipConsent`). | [src/convex/client/index.ts:486](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L486) |
| <a id="oidcconfig"></a> `oidcConfig?` | `OIDCOptions` | Advanced OIDC provider passthrough; the options above win over it. | [src/convex/client/index.ts:488](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L488) |

***

### CreateBetterAuthOptions

Defined in: [src/convex/client/index.ts:491](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L491)
...
| Property | Type | Description | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="authconfig"></a> `authConfig?` | `AuthConfig` | Override the default auth config (e.g. to add custom providers) | [src/convex/client/index.ts:493](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L493) |
| <a id="authoptions"></a> `authOptions?` | `BetterAuthOptions` | Override Better Auth options (merged with defaults) | [src/convex/client/index.ts:495](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L495) |
| <a id="basepath"></a> `basePath?` | `string` | Override Better Auth basePath and matching Convex auth route | [src/convex/client/index.ts:497](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L497) |
| <a id="admin"></a> `admin?` | `false` \| `AdminOptions` | Admin plugin options (roles via `adminRoles`/`ac`, ban, impersonation). Enabled by default; pass `false` to disable — a disabled plugin still leaves its (optional) schema fields in place. | [src/convex/client/index.ts:503](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L503) |
| <a id="organization"></a> `organization?` | \| `false` \| `OrganizationOptions` & \{ `personal?`: `boolean`; `invitationPath?`: `string`; \} | Organization (workspace) plugin options. Enabled by default with a personal workspace per user (`personal: true`); pass `false` to disable. | [src/convex/client/index.ts:508](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L508) |
| <a id="mcp"></a> `mcp?` | `false` \| [`McpAuthOptions`](#mcpauthoptions) | Agent (MCP) OAuth provider options. Enabled by default — apps built on this package expose an OAuth-protected MCP endpoint out of the box; pass `false` to disable the provider (and the `/mcp/exchange` token mint). | [src/convex/client/index.ts:514](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L514) |

***

### SetupAuthOptions

Defined in: [src/convex/client/index.ts:517](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L517)
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="authconfig-1"></a> `authConfig?` | `AuthConfig` | Override the default auth config (e.g. to add custom providers) | [`CreateBetterAuthOptions`](#createbetterauthoptions).[`authConfig`](#authconfig) | [src/convex/client/index.ts:493](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L493) |
| <a id="authoptions-1"></a> `authOptions?` | `BetterAuthOptions` | Override Better Auth options (merged with defaults) | [`CreateBetterAuthOptions`](#createbetterauthoptions).[`authOptions`](#authoptions) | [src/convex/client/index.ts:495](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L495) |
| <a id="basepath-1"></a> `basePath?` | `string` | Override Better Auth basePath and matching Convex auth route | [`CreateBetterAuthOptions`](#createbetterauthoptions).[`basePath`](#basepath) | [src/convex/client/index.ts:497](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L497) |
| <a id="admin-1"></a> `admin?` | `false` \| `AdminOptions` | Admin plugin options (roles via `adminRoles`/`ac`, ban, impersonation). Enabled by default; pass `false` to disable — a disabled plugin still leaves its (optional) schema fields in place. | [`CreateBetterAuthOptions`](#createbetterauthoptions).[`admin`](#admin) | [src/convex/client/index.ts:503](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L503) |
| <a id="organization-1"></a> `organization?` | \| `false` \| `OrganizationOptions` & \{ `personal?`: `boolean`; `invitationPath?`: `string`; \} | Organization (workspace) plugin options. Enabled by default with a personal workspace per user (`personal: true`); pass `false` to disable. | [`CreateBetterAuthOptions`](#createbetterauthoptions).[`organization`](#organization) | [src/convex/client/index.ts:508](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L508) |
| <a id="mcp-1"></a> `mcp?` | `false` \| [`McpAuthOptions`](#mcpauthoptions) | Agent (MCP) OAuth provider options. Enabled by default — apps built on this package expose an OAuth-protected MCP endpoint out of the box; pass `false` to disable the provider (and the `/mcp/exchange` token mint). | [`CreateBetterAuthOptions`](#createbetterauthoptions).[`mcp`](#mcp) | [src/convex/client/index.ts:514](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L514) |
| <a id="schema-1"></a> `schema?` | `Schema` | Local Better Auth schema for hybrid/local component installs | - | [src/convex/client/index.ts:522](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L522) |
| <a id="verbose"></a> `verbose?` | `boolean` | Enable verbose logs in the Better Auth Convex component client | - | [src/convex/client/index.ts:524](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L524) |
| <a id="integrations"></a> `integrations?` | [`AuthIntegrations`](#authintegrations)\<`DM`\> | Cross-component wiring: an email transport for auth emails, a rate limiter for OTP sends, a `canSignIn` gate, and the `onUserCreated` / `onUserDeleted` lifecycle hooks. See [AuthIntegrations](#authintegrations). | - | [src/convex/client/index.ts:530](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L530) |

***

### AuthSetupComponents

Defined in: [src/convex/client/index.ts:547](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L547)
...
| Property | Type | Defined in |
| ------ | ------ | ------ |
| <a id="backend"></a> `backend` | `PublicAuthComponentRef` | [src/convex/client/index.ts:548](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L548) |
...
Defined in: [src/convex/client/index.ts:117](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L117)
...
Defined in: [src/convex/client/index.ts:130](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L130)
...
Defined in: [src/convex/client/index.ts:145](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L145)
...
Defined in: [src/convex/client/index.ts:155](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L155)
...
Defined in: [src/convex/client/index.ts:456](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L456)
...
| ------ | ------ | ------ |
| `personal?` | `boolean` | [src/convex/client/index.ts:457](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L457) |
| `invitationPath?` | `string` | [src/convex/client/index.ts:458](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L458) |
...
Defined in: [src/convex/client/index.ts:287](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L287)
...
Defined in: [src/convex/client/index.ts:748](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L748)
...
| `basePath` | `string` | `resolvedBasePath` | - | [src/convex/client/index.ts:964](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L964) |
| `database` | `AdapterFactory`\<`BetterAuthOptions`\> | - | - | [src/convex/client/index.ts:965](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L965) |
| `emailAndPassword` | \{ `disableSignUp?`: `boolean`; `requireEmailVerification?`: `boolean`; `maxPasswordLength?`: `number`; `minPasswordLength?`: `number`; `sendResetPassword?`: (`data`, `request?`) => `Promise`\<`void`\>; `resetPasswordTokenExpiresIn?`: `number`; `onPasswordReset?`: (`data`, `request?`) => `Promise`\<`void`\>; `password?`: \{ `hash?`: (`password`) => `Promise`\<`string`\>; `verify?`: (`data`) => `Promise`\<`boolean`\>; \}; `autoSignIn?`: `boolean`; `revokeSessionsOnPasswordReset?`: `boolean`; `onExistingUserSignUp?`: (`data`, `request?`) => `Promise`\<`void`\>; `customSyntheticUser?`: (`params`) => `Record`\<`string`, `unknown`\>; `enabled`: `boolean`; \} | - | - | [src/convex/client/index.ts:967](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L967) |
...
| `emailAndPassword.enabled` | `boolean` | `false` | Enable email and password authentication **Default** `false` | [src/convex/client/index.ts:968](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L968) |
| `user` | \{ `modelName?`: `"user"` \| `LiteralString`; `fields?`: `Partial`\<`Record`\<`"createdAt"` \| `"updatedAt"` \| `"email"` \| `"emailVerified"` \| `"name"` \| `"image"`, `string`\>\>; `additionalFields?`: \{ \[`key`: `string`\]: `DBFieldAttribute`; \}; `changeEmail?`: \{ `enabled`: `boolean`; `sendChangeEmailConfirmation?`: (`data`, `request?`) => `Promise`\<`void`\>; `updateEmailWithoutVerification?`: `boolean`; \}; `deleteUser?`: \{ `enabled?`: `boolean`; `sendDeleteAccountVerification?`: (`data`, `request?`) => `Promise`\<`void`\>; `beforeDelete?`: (`user`, `request?`) => `Promise`\<`void`\>; `afterDelete?`: (`user`, `request?`) => `Promise`\<`void`\>; `deleteTokenExpiresIn?`: `number`; \}; \} | - | - | [src/convex/client/index.ts:973](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L973) |
...
Defined in: [src/convex/client/index.ts:1070](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1070)
...
Defined in: [src/convex/client/index.ts:1077](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1077)
...
Defined in: [src/convex/client/index.ts:1104](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1104)
...
Defined in: [src/convex/client/index.ts:1150](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1150)
...
| Name | Type | Defined in |
| ------ | ------ | ------ |
| `getAuthUser` | `RegisteredQuery`\<`"public"`, \{ \}, `Promise`\<`MaybeMakeLooseDataModel`\<\{ \[TableName in string\]: Schema\["tables"\]\[TableName\] extends TableDefinition\<DocumentType, Indexes, SearchIndexes, VectorIndexes\> ? \{ document: Expand\<(...) & (...)\>; fieldPaths: "\_id" \| ExtractFieldPaths\<(...)\>; indexes: Expand\<(...) & (...)\>; searchIndexes: SearchIndexes; vectorIndexes: VectorIndexes \} : never \}, `Schema`\[`"strictTableNameTypes"`\]\>\[`"user"`\]\[`"document"`\]\>\> | [src/convex/client/index.ts:1283](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1283) |
| `authConfig` | `RegisteredQuery`\<`"public"`, \{ \}, `Promise`\<\{ `invitationPath`: `string` \| `null`; \}\>\> | [src/convex/client/index.ts:1284](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1284) |
| `listWorkspaces` | `RegisteredQuery`\<`"public"`, \{ \}, `Promise`\< \| \{ `id`: `string`; `name`: `string`; `slug`: `string`; `logo`: `string` \| `null`; `role`: `string`; `active`: `boolean`; `joinedAt`: `number`; \}[] \| `null`\>\> | [src/convex/client/index.ts:1285](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1285) |
| `listWorkspaceMembers` | `RegisteredQuery`\<`"public"`, \{ `organizationId?`: `string`; \}, `Promise`\< \| \{ `organizationId`: `string`; `members`: \{ `userId`: `string`; `name`: `string`; `email`: `string`; `role`: `string`; `joinedAt`: `number`; \}[]; \} \| `null`\>\> | [src/convex/client/index.ts:1286](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1286) |
| `updateProfile` | `RegisteredMutation`\<`"public"`, \{ `name`: `string`; \}, `Promise`\<`null`\>\> | [src/convex/client/index.ts:1287](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1287) |
...
Defined in: [src/convex/client/index.ts:1308](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L1308)
...
| `options.basePath` | `string` | `resolvedBasePath` | - | [src/convex/client/index.ts:964](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L964) |
| `options.database` | `AdapterFactory`\<`BetterAuthOptions`\> | - | - | [src/convex/client/index.ts:965](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L965) |
...
| `options.emailAndPassword.enabled` | `boolean` | `false` | Enable email and password authentication **Default** `false` | [src/convex/client/index.ts:968](https://github.com/qruto/nuxt-backend/blob/main/src/convex/client/index.ts#L968) |
