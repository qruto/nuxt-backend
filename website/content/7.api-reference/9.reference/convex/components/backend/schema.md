...
Defined in: [nuxt-backend/src/convex/components/backend/schema.ts:204](https://github.com/qruto/nuxt-backend/blob/main/src/convex/components/backend/schema.ts#L204)
