---
title: "convex/integrations/workflows"
description: "API reference for nuxt-backend/workflows."
navigation:
  title: "workflows"
...
Defined in: [src/convex/integrations/workflows.ts:68](https://github.com/qruto/nuxt-backend/blob/main/src/convex/integrations/workflows.ts#L68)
...
| ------ | ------ | ------ | ------ |
| <a id="after"></a> `after` | `number` | Delay before this step, in milliseconds from the previous one. | [src/convex/integrations/workflows.ts:70](https://github.com/qruto/nuxt-backend/blob/main/src/convex/integrations/workflows.ts#L70) |
| <a id="email"></a> `email` | (`data`) => \| \{ `to`: `string`; `subject`: `string`; `html?`: `string`; `text?`: `string`; \} \| `null` | Build the email for this step — or return `null` to skip it (e.g. the user already activated and the nudge is moot). | [src/convex/integrations/workflows.ts:75](https://github.com/qruto/nuxt-backend/blob/main/src/convex/integrations/workflows.ts#L75) |
...
Defined in: [src/convex/integrations/workflows.ts:58](https://github.com/qruto/nuxt-backend/blob/main/src/convex/integrations/workflows.ts#L58)
...
Defined in: [src/convex/integrations/workflows.ts:109](https://github.com/qruto/nuxt-backend/blob/main/src/convex/integrations/workflows.ts#L109)
