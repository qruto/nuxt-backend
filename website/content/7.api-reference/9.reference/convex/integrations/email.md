...
| `backend.email.send` | `FunctionReference`\<`"mutation"`, `"internal"`, [`SendEmailOptions`](#sendemailoptions), `string` \| `null`\> | - | [src/convex/integrations/email.ts:25](https://github.com/qruto/nuxt-backend/blob/main/src/convex/integrations/email.ts#L25) |
| `backend.email.status` | `FunctionReference`\<`"query"`, `"internal"`, \{ `emailId`: `string`; \}, [`EmailStatus`](#emailstatus) \| `null`\> | - | [src/convex/integrations/email.ts:26](https://github.com/qruto/nuxt-backend/blob/main/src/convex/integrations/email.ts#L26) |
| `backend.email.get` | `FunctionReference`\<`"query"`, `"internal"`, \{ `emailId`: `string`; \}, `unknown`\> | - | [src/convex/integrations/email.ts:27](https://github.com/qruto/nuxt-backend/blob/main/src/convex/integrations/email.ts#L27) |
| `backend.email.cancel` | `FunctionReference`\<`"mutation"`, `"internal"`, \{ `emailId`: `string`; \}, `null`\> | - | [src/convex/integrations/email.ts:28](https://github.com/qruto/nuxt-backend/blob/main/src/convex/integrations/email.ts#L28) |
...
| `backend.email.cleanupAbandoned?` | `FunctionReference`\<`"mutation"`, `"internal"`, \{ `olderThanMs?`: `number`; \}, `null`\> | - | [src/convex/integrations/email.ts:36](https://github.com/qruto/nuxt-backend/blob/main/src/convex/integrations/email.ts#L36) |
| `backend.email.handleWebhook` | `FunctionReference`\<`"action"`, `"internal"`, \{ `body`: `string`; `headers`: `Record`\<`string`, `string`\>; \}, \{ `status`: `number`; `body`: `string`; `type?`: `string`; \}\> | - | [src/convex/integrations/email.ts:37](https://github.com/qruto/nuxt-backend/blob/main/src/convex/integrations/email.ts#L37) |
