---
title: "runtime/server/mcp"
description: "API reference for nuxt-backend/mcp."
navigation:
  title: "mcp"
...
| Parameter | Type |
| ------ | ------ |
| `key` | \| `"getAuthUser"` \| `"updateProfile"` \| `"getConfiguredProducts"` \| `"getCurrentSubscription"` \| `"getCredits"` \| `"generateCheckoutLink"` \| `"generateCustomerPortalUrl"` \| `"listWorkspaces"` \| `"listWorkspaceMembers"` |
...
| Parameter | Type |
| ------ | ------ |
| `name` | [`BackendMcpToolName`](/api-reference/reference/module#backendmcptoolname) |
| `event` | `H3Event` |
...
Re-exports [BackendMcpFunctionKey](/api-reference/reference/module#backendmcpfunctionkey)

***

### BackendMcpToolName

Re-exports [BackendMcpToolName](/api-reference/reference/module#backendmcptoolname)
