...
Defined in: [nuxt-backend/src/runtime/vue/composables/use-ai-stream.ts:62](https://github.com/qruto/nuxt-backend/blob/main/src/runtime/vue/composables/use-ai-stream.ts#L62)
