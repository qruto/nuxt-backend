...
Defined in: [nuxt-backend/src/convex/app.ts:77](https://github.com/qruto/nuxt-backend/blob/2319feb8b3523db41f3ec9ed6900095e65f4ee42/src/convex/app.ts#L77)
...
Defined in: [nuxt-backend/src/convex/app.ts:70](https://github.com/qruto/nuxt-backend/blob/2319feb8b3523db41f3ec9ed6900095e65f4ee42/src/convex/app.ts#L70)
...
Defined in: [nuxt-backend/src/convex/app.ts:32](https://github.com/qruto/nuxt-backend/blob/2319feb8b3523db41f3ec9ed6900095e65f4ee42/src/convex/app.ts#L32)
...
| ------ | ------ | ------ |
| <a id="property-auth_secret"></a> `AUTH_SECRET` | `VString`\<`string`, `"required"`\> | [nuxt-backend/src/convex/app.ts:34](https://github.com/qruto/nuxt-backend/blob/2319feb8b3523db41f3ec9ed6900095e65f4ee42/src/convex/app.ts#L34) |
| <a id="property-site_url"></a> `SITE_URL` | `VString`\<`string`, `"required"`\> | [nuxt-backend/src/convex/app.ts:35](https://github.com/qruto/nuxt-backend/blob/2319feb8b3523db41f3ec9ed6900095e65f4ee42/src/convex/app.ts#L35) |
| <a id="property-email_api_key"></a> `EMAIL_API_KEY` | `VString`\<`string`, `"required"`\> | [nuxt-backend/src/convex/app.ts:37](https://github.com/qruto/nuxt-backend/blob/2319feb8b3523db41f3ec9ed6900095e65f4ee42/src/convex/app.ts#L37) |
| <a id="property-email_from"></a> `EMAIL_FROM` | `VString`\<`string`, `"required"`\> | [nuxt-backend/src/convex/app.ts:38](https://github.com/qruto/nuxt-backend/blob/2319feb8b3523db41f3ec9ed6900095e65f4ee42/src/convex/app.ts#L38) |
| <a id="property-email_test_mode"></a> `EMAIL_TEST_MODE` | `VString`\<`string`, `"required"`\> | [nuxt-backend/src/convex/app.ts:39](https://github.com/qruto/nuxt-backend/blob/2319feb8b3523db41f3ec9ed6900095e65f4ee42/src/convex/app.ts#L39) |
| <a id="property-email_webhook_secret"></a> `EMAIL_WEBHOOK_SECRET` | `VString`\<`string`, `"required"`\> | [nuxt-backend/src/convex/app.ts:40](https://github.com/qruto/nuxt-backend/blob/2319feb8b3523db41f3ec9ed6900095e65f4ee42/src/convex/app.ts#L40) |
| <a id="property-billing_access_token"></a> `BILLING_ACCESS_TOKEN` | `VString`\<`string`, `"required"`\> | [nuxt-backend/src/convex/app.ts:42](https://github.com/qruto/nuxt-backend/blob/2319feb8b3523db41f3ec9ed6900095e65f4ee42/src/convex/app.ts#L42) |
| <a id="property-billing_webhook_secret"></a> `BILLING_WEBHOOK_SECRET` | `VString`\<`string`, `"required"`\> | [nuxt-backend/src/convex/app.ts:43](https://github.com/qruto/nuxt-backend/blob/2319feb8b3523db41f3ec9ed6900095e65f4ee42/src/convex/app.ts#L43) |
| <a id="property-billing_environment"></a> `BILLING_ENVIRONMENT` | `VUnion`\<`"sandbox"` \| `"production"`, \[`VLiteral`\<`"sandbox"`, `"required"`\>, `VLiteral`\<`"production"`, `"required"`\>\], `"required"`, `never`\> | [nuxt-backend/src/convex/app.ts:44](https://github.com/qruto/nuxt-backend/blob/2319feb8b3523db41f3ec9ed6900095e65f4ee42/src/convex/app.ts#L44) |
...
Defined in: [nuxt-backend/src/convex/app.ts:122](https://github.com/qruto/nuxt-backend/blob/2319feb8b3523db41f3ec9ed6900095e65f4ee42/src/convex/app.ts#L122)
...
Defined in: [nuxt-backend/src/convex/app.ts:179](https://github.com/qruto/nuxt-backend/blob/2319feb8b3523db41f3ec9ed6900095e65f4ee42/src/convex/app.ts#L179)
