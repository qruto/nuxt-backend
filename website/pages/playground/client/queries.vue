...
/**
 * Real-life framing: a small live dashboard. `useQueries` holds a whole
...
<template>
  <div class="stack">
    <PageHeader
      tag="useQuery · useQueries · useQuery_experimental"
      title="Queries"
      live
    >
      Reactive reads against Convex. One <code>useQueries</code> call holds a
