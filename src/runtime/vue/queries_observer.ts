/**
 * Port of convex-js/src/react/queries_observer.ts
 *
 * This class is framework-agnostic (no React or Vue dependencies).
 * It is ported verbatim from the React source to simplify future updates.
 *
 * @see https://github.com/get-convex/convex-js/blob/a6e554e/src/react/queries_observer.ts
 * @internal
 */
...
/**
 * Mirrors convex-js Watch interface from src/react/client.ts
 * @internal
 */
...
/**
 * QueryJournal type — opaque in the public API.
 * @internal
 */
export type QueryJournal = unknown
